...
<body class="pt-1" >
    ...
    <form action="thank-you.php" method="POST">
      ...
      <br>
      <p class="h4 mb-3 font-weight-normal text-primary"> Have you been in contact with anyone who has known symptoms of COVID-19 or been diagnosed as COVID-19 positive?</p>
       <div class="container">
        <div class="row" >
