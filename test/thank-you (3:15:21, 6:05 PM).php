...
if ($testReq == "No" && $EXEMPT == "No" && $TrackerCount <= $DailayTotal && $Location == "New York City" && $I_will_be == "On-Campus" && ($Date == "03/15/2021" || $Date == "03/18/2021")) {
...
if ($testReq == "No" && $EXEMPT == "No" && $TrackerCount <= $DailayTotal && $Location == "South Beach" && $I_will_be == "On-Campus" && ($Date == "03/17/2021" || $Date == "03/18/2021")) {
...
if ($testReq == "No" && $EXEMPT == "No" && $TrackerCount <= $DailayTotal && $Location == "Los Angeles" && $I_will_be == "On-Campus" && ($Date == "03/19/2021")) {
...
if ($Positive == "No" && $testReq == "Yes" && $testCom == "No" && $I_will_be == "On-Campus" && ($Date == "03/08/2021" || $Date == "03/10/2021" || $Date == "03/11/2021")) {
  if ($Location == "Los Angeles"){
    $message = "<strong>You've been selected to take a COVID Test on campus today.<br>Please report to room R313 (Truffaut) at the Riverside building between 9:00am and 4:00pm.<br>Testing should take 5 minutes.</strong><br><br>" . $message;
  }elseif ($Location == "South Beach"){
    $message = "<strong>You've been selected to take a COVID Test on campus today.<br>Please report to Fellini Room before 4:00pm.<br>Testing should take 5 minutes.</strong><br><br>" . $message;
  }else{
    $message = "<strong>You've been selected to take a COVID Test on campus today.<br>Please report to room 505 before 4:00pm.<br>Testing should take 5 minutes.</strong><br><br>" . $message;
  }
}
