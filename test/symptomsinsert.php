...
if ($testReq == "No" && $EXEMPT == "No" && $TrackerCount <= $DailayTotal && $Location == "New York City" && $I_will_be == "On-Campus" && ($Date == "07/07/2021" || $Date == "07/08/2021")) {
...
if ($testReq == "No" && $EXEMPT == "No" && $TrackerCount <= $DailayTotal && $Location == "South Beach" && $I_will_be == "On-Campus" && ($Date == "07/12/2021" || $Date == "07/07/2021" || $Date == "07/08/2021")) {
...
if ($testReq == "No" && $EXEMPT == "No" && $TrackerCount <= $DailayTotal && $Location == "Los Angeles" && $I_will_be == "On-Campus" && ($Date == "07/06/2021" || $Date == "07/07/2021")) {
...
if ($Positive == "No" && $testReq == "Yes" && $testCom == "No" && $I_will_be == "On-Campus" && ($Date == "07/12/2021" || $Date == "07/07/2021" || $Date == "07/08/2021" || $Date == "07/01/2021")) {
  if ($Location == "Los Angeles"){
...
if ($Location == "Los Angeles") {
  ...
  $VaccMessage = "If you have been FULLY VACCINATED, send a photo or scan of your vaccination card to covidteamla@nyfa.edu<br><br>Employees, please upload proof of COVID-19 vaccination to Paycom";

}elseif ($Location == "South Beach") {
  $ReplyTo = "covidteamsb@nyfa.edu";
  $VaccMessage = "If you have been FULLY VACCINATED, send a photo or scan of your vaccination card to covidteamsb@nyfa.edu<br><br>Employees, please upload proof of COVID-19 vaccination to Paycom";
}else{
  $ReplyTo = "covidteamny@nyfa.edu";
  $VaccMessage = "If you have been FULLY VACCINATED, send a photo or scan of your vaccination card to covidteamny@nyfa.edu<br><br>Employees, please upload proof of COVID-19 vaccination to Paycom";
}
