...
<body class="pt-1"  >
    ...
    <form action="thank-you.php" method="POST">
      ...
      <br>
      <p class="h4 mb-3 font-weight-normal text-primary">Have you been in contact in the past 14 days with anyone with suspected or confirmed COVID-19?</p>
       <div class="container">
        <div class="row" >
        ...
        <br>
      <p class="h4 mb-3 font-weight-normal text-primary">In the past 14 days, have you traveled internationally or arrived/returned  to campus from a location with high rates of coronavirus infection?</p>
       <div class="container">
        <div class="row" >
            <div class="custom-control custom-radio padding col col1 " >
      ...
      By clicking submit, I am renewing my Pledge to Care for my NYFA Community and Comply with the COVID Safety Plan.
