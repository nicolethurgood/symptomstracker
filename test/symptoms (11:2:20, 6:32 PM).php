    ...
    <form action="thank-you.php" method="POST">
      ...
      <p class="h4 mb-3 font-weight-normal text-primary">Have you been in contact in the past 14 days with anyone with suspected or confirmed COVID-19?</p>
       <div class="container">
        ...
        </div><p class="h4 mb-3 font-weight-normal text-primary">In the past 14 days, have you traveled internationally or arrived/returned  to campus from a location with high rates of coronavirus infection?</p>
       <div class="container">
        <div class="row" >
            <div class="custom-control custom-radio padding col col1 " >
        ...
        <div class="container">
        <div class="row">
          <label class="mb-2 padding ">Today, I will be (choose one):</label>
