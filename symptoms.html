...
<div class="headercontainer">
    ...
    <form action="symptomsinsert.php" method="POST">
        ...
        <input type="hidden" name="sTestReq" id="sTestReq" value="<? echo $_SESSION['TestReq']; ?>" >
        <input type="hidden" name="sTestComp" id="sTestComp" value="<? echo $_SESSION['TestComp']; ?>" >
        <input type="hidden" name="sEXEMPT" id="sEXEMPT" value="<? echo $_SESSION['EXEMPT']; ?>" >
        <input type="hidden" name="sVaccCom" id="sVaccCom" value="<? echo $_SESSION['VaccCom']; ?>" >
        <input type="hidden" name="sName" id="sName" value="<? echo $_SESSION['Name']; ?>" >
      <div class="container">
        <div class="row">
      ...
      <p class="h5 mb-3 font-weight-normal text-primary">Have you been in contact in the past 10 days with anyone with suspected or confirmed COVID-19?</p>
       <div class="container">
        ...
        </div><p class="h5 mb-3 font-weight-normal text-primary">In the past 10 days, have you traveled from a location outside your campus region?</p>
       <div class="container">
        <div class="row" >
            <div class="custom-control custom-radio padding col col1 " >
        ...
        <p class="h5 mb-3 font-weight-normal text-primary" style="color:#CC0000 !important;">If you have been FULLY VACCINATED, send a photo or scan of your vaccination card to 
        <?php
        ...
        ?>
        Employees, please upload proof of COVID-19 vaccination to Paycom<br>
        </p>
        <div class="container">
        <div class="row">
      ...
      <center style="font-size: small;">Source: <a href="https://www.cdc.gov/coronavirus/2019-ncov/symptoms-testing/symptoms.html">Centers for Disease Control and Prevention</a></center>
        <br><br><br>
