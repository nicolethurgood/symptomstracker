  ...
  <div class="container">
    <div class="row">
      <label class="mb-3 padding col col1">Cough </label>
        ...
        <input id="coughYes" name="symptoms1" type="radio" class="custom-control-input"  required >
        <label class="custom-control-label" for="coughYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="coughNo" name="symptoms1" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Difficulty Breathing/Shortness of Breath</label>
        <div class="custom-control custom-radio padding" >
        <input id="breathYes" name="symptoms2" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="breathYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="breathNo" name="symptoms2" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Fever (above 99.5)</label>
        <div class="custom-control custom-radio padding" >
        <input id="feverYes" name="symptoms3" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="feverYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="feverNo" name="symptoms3" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Chills</label>
        <div class="custom-control custom-radio padding" >
        <input id="chillsYes" name="symptoms4" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="chillsYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="chillsNo" name="symptoms4" type="radio" class="custom-control-input"   required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Fatigue (unexplained)</label>
        <div class="custom-control custom-radio padding" >
        <input id="fatigueYes" name="symptoms5" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="fatigueYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="fatigueNo" name="symptoms5" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Muscle or Body Aches</label>
        <div class="custom-control custom-radio padding" >
        <input id="achesYes" name="symptoms6" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="achesYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="achesNo" name="symptoms6" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Headache</label>
        <div class="custom-control custom-radio padding" >
        <input id="headacheYes" name="symptoms7" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="headacheYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="headacheNo" name="symptoms7" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">New Loss of Taste or Smell</label>
        <div class="custom-control custom-radio padding" >
        <input id="lossYes" name="symptoms8" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="lossYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="lossNo" name="symptoms8" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Sore Throat</label>
        <div class="custom-control custom-radio padding" >
        <input id="throatYes" name="symptoms9" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="throatYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="throatNo" name="symptoms9" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Congestion or Runny Nose</label>
        <div class="custom-control custom-radio padding" >
        <input id="congestionYes" name="symptoms10" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="congestionYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="congestionNo" name="symptoms10" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Diarrhea</label>
        <div class="custom-control custom-radio padding" >
        <input id="diarrheaYes" name="symptoms11" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="diarrheaYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="diarrheaNo" name="symptoms11" type="radio" class="custom-control-input" required>
    ...
    <div class="row">
      <label class="mb-3 padding col col1">Nausea or Vomiting (unexplained)</label>
        <div class="custom-control custom-radio padding" >
        <input id="nauseaYes" name="symptoms12" type="radio" class="custom-control-input"  required>
        <label class="custom-control-label" for="nauseaYes">Yes</label>
        </div>
        <div class="custom-control custom-radio padding">
        <input id="nauseaNo" name="symptoms12" type="radio" class="custom-control-input" required>
