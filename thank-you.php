  ...
  <body class="text-center">
   ...
   <div class="content">
      <center>
        ...
        <div class="row col-lg-10 col-md-10 col-sm-12" style="width: 100%; text-align: center;">
          ...
          <div class="col-12 mobile ">
             ...
             <div class="icon left right top bottom col-lg-4 col-md-4 col-sm-4 ">
            <img src="https://www.nyfa.edu/symptoms-tracking/images/vaccine-card-icon-m.png">
            <Br><Br>
            <b>Email Vax card to COVID Team</b>
          </div>
<!--
            <div class="icon right top bottom col-lg-4 col-md-4 col-sm-4 mobile ">
            <img src="https://www.nyfa.edu/symptoms-tracking/images/vaccine-card-icon-m.png">
            <Br><Br>
            <b>Email Vax card to COVID Team</b>
          </div>
-->
          ...
          <div class="icon left right top bottom col-lg-3 col-md-4 col-sm-4 ">
